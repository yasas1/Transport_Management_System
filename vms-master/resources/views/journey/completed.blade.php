                    ...
                    eventClick: function(event, element) {
                        ...
                        $.ajax({
                            ...
                            success: function(data)
                            {
                                ...
                                console.log(new Date(Date.parse(details[0].confirmed_start_date_time)));
                                ...
                                $('#confirm_by').html(details[9]);
                                $('#confirm_at').html(details[10]);
                                $('#confirm_remarks').html(details[0].confirmation_remarks);
                                $('#confirmed_start_date_time').html(new Date(Date.parse(details[0].confirmed_start_date_time ,"Y-m-d")));
                                $('#confirmed_end_date_time').html(details[0].confirmed_end_date_time);

                                $('#driver_completed_at').html(details[0].driver_completed_at);
                                $('#driver_remarks').html(details[0].driver_remarks);
                                $('#real_distance').html(details[0].real_distance);
                                $('#real_start_date_time').html(details[0].real_start_date_time);
                                $('#real_end_date_time').html(details[0].real_end_date_time);
                            }
                        });
                        $('#modal').modal('toggle');
